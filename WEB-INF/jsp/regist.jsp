		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="register" method="get" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									<input type="text" value="<s:property value="username"/>" id="username" name="username" class="text" maxlength="20">
							...
							<tr>
								...
								<td>
									<input type="password" value="<s:property value="password"/>" id="password" name="password" class="text" maxlength="20" autocomplete="off">
							...
							<tr>
								...
								<td>
									<input type="password" value="<s:property value="repassword"/>" name="repassword" class="text" maxlength="20" autocomplete="off">
							...
							<tr>
								...
								<td>
									<input type="text" id="email" value="${email }" name="email" class="text" maxlength="200">
									${fieldErrors.email }
								</td>
							</tr>
									<tr>
