					...
					<ul class="tab">
							...
							<ul class="tabContent" style="display: block;">
									<c:forEach items="${products }" var="product">
										<li>
											<a href="product?pid=${product.pid }"><img src="${product.image }" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
										</li>
									</c:forEach>
...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
						 			<c:forEach items="${news }" var="product">
						 				<li>
											<a  href="#"><img src="${product.image }" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>
										</li> 
						 			</c:forEach>
									<!-- <li>
										<a  target="_blank"><img src="./image/l.jpg" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>
										</li> 
